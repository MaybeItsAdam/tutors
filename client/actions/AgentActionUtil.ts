...
/**
 * Check whether an action util is registered for a given action type.
 */
export function hasRegisteredActionUtil(type: string): boolean {
...
export function getAgentActionUtilsRecord(agent: TldrawAgent) {
	...
	for (const [type, util] of registry.entries()) {
