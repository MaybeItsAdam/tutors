...
/**
 * tldraw's class-method render pattern breaks rules-of-hooks linting and
 * previously had hooks BELOW an early return (a genuine crash if a shape
 * transitioned between empty and non-empty assetIds). A real function
 * component fixes both.
 */
function PdfDocumentComponent({ shape }: { shape: IPdfDocumentShape }) {
