...
export const PDF_THUMBNAIL_CONTAINER_MIN_W = 72
export const PDF_THUMBNAIL_CONTAINER_MAX_W = 220
export const PDF_THUMBNAIL_CONTAINER_W_PADDING = 20
export const PDF_THUMBNAIL_CONTAINER_MIN_H = 92
export const PDF_THUMBNAIL_CONTAINER_MAX_H = 300
export const PDF_THUMBNAIL_CONTAINER_H_PADDING = 58
